...
char string[250]; //string we will use to store the result of the request. Set it to a lenght at least as long and the result of your SNMP get request
char * chars = string; //char pointer used to referance the string
int timeDelay = 20000; // delay in milliseconds
...
IPAddress netAdd = IPAddress(192,168,0,101); // IP address object of the device you want to get info from
...
snmp.addIntegerHandler(".1.3.6.1.2.1.31.1.1.1.10.2", &byteUp, true);  
callbackUpLoad = snmp.findCallback(".1.3.6.1.2.1.31.1.1.1.10.2", false);
//1.3.6.1.4.1.6574.1.2.0     //nas-temp
//1.3.6.1.2.1.31.1.1.1.10.2  //lan-out
}
